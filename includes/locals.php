<?php
	function theme_local_init() {
		...
		$cherry_locals_arr = array(
			...
			'import_sample_data_desc' => __('If you want to install sample data from livedemo you need to go to <strong>Cherry plugin</strong> > <strong><a href="?page=import-page">Import</a></strong> and follow the tips.', $domain),
			'import_sample_data_desc_2' => __('If you want to install sample data from livedemo you need to go to <strong><a href="?page=import-page">Import</a></strong> and follow the tips.', $domain),
