...
function cherry_scripts() {
	if (!is_admin()) {
		...
		wp_enqueue_script('magnific-popup', get_template_directory_uri().'/js/jquery.magnific-popup.min.js', array('jquery'), '0.8.9', true);
...
function cherry_stylesheets() {
	...
	wp_enqueue_style('magnific-popup-css', get_template_directory_uri().'/css/magnific-popup.css', false, '0.8.9', 'all');
}
