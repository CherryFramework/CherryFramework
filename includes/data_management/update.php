...
/******************Change this*******************/
$api_url = 'http://updates.cherry.template-help.com/cherrymoto/api/';
/************************************************/
...
function check_for_update($checked_data) {
	global $wp_version, $theme_version, $theme_base, $api_url, $update_cherry;
